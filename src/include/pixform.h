...
#define DECOMPOSE_PIXEL_BGR565(PIX, R, G, B)                                                                           \
	{                                                                                                              \
		(B) = (PIX) >> 11;                                                                                     \
		(G) = ((PIX) >> 6) & 0x1f;                                                                             \
		(R) = (PIX)&0x1f;                                                                                      \
...
#define DECOMPOSE_PIXEL_BGR555(PIX, R, G, B)                                                                           \
	{                                                                                                              \
		(B) = (PIX) >> 10;                                                                                     \
		(G) = ((PIX) >> 5) & 0x1f;                                                                             \
		(R) = (PIX)&0x1f;                                                                                      \
...
#define DECOMPOSE_PIXEL_GBR565(PIX, R, G, B)                                                                           \
	{                                                                                                              \
		(G) = (PIX) >> 11;                                                                                     \
		(B) = ((PIX) >> 6) & 0x1f;                                                                             \
		(R) = (PIX)&0x1f;                                                                                      \
...
#define DECOMPOSE_PIXEL_GBR555(PIX, R, G, B)                                                                           \
	{                                                                                                              \
		(G) = (PIX) >> 10;                                                                                     \
		(B) = ((PIX) >> 5) & 0x1f;                                                                             \
		(R) = (PIX)&0x1f;                                                                                      \
...
#define DECOMPOSE_PIXEL_RGB5551(PIX, R, G, B)                                                                          \
	{                                                                                                              \
		(R) = (PIX) >> 11;                                                                                     \
		(G) = ((PIX) >> 6) & 0x1f;                                                                             \
		(B) = ((PIX) >> 1) & 0x1f;                                                                             \
