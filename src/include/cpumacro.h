...
static void ADC8(long Addr)
{
	...
	if (CheckDecimal()) {
		...
		if (~(ICPU.Registers.AL ^ Work8) & (Work8 ^ (uint8)Ans16) & 0x80)
			SetOverflow();
		else
			ClearOverflow();
...
static void ADC16(long Addr)
{
	...
	if (CheckDecimal()) {
		...
		if (~(ICPU.Registers.A.W ^ Work16) & (Work16 ^ (uint16)Ans32) & 0x8000)
			SetOverflow();
		else
			ClearOverflow();
...
{
	int32 Int32 = (long)ICPU.Registers.A.W - (long)S9xGetWord(Addr);
	ICPU._Carry = Int32 >= 0;
...
{
	int16 Int16 = (short)ICPU.Registers.AL - (short)S9xGetByte(Addr);
	ICPU._Carry = Int16 >= 0;
	SetZN8((uint8)Int16);
}
...
{
	int32 Int32 = (long)ICPU.Registers.X.W - (long)S9xGetWord(Addr);
	ICPU._Carry = Int32 >= 0;
	SetZN16((uint16)Int32);
}
...
{
	int16 Int16 = (short)ICPU.Registers.XL - (short)S9xGetByte(Addr);
	ICPU._Carry = Int16 >= 0;
	SetZN8((uint8)Int16);
}
...
{
	int32 Int32 = (long)ICPU.Registers.Y.W - (long)S9xGetWord(Addr);
	ICPU._Carry = Int32 >= 0;
	SetZN16((uint16)Int32);
}
...
{
	int16 Int16 = (short)ICPU.Registers.YL - (short)S9xGetByte(Addr);
	ICPU._Carry = Int16 >= 0;
	SetZN8((uint8)Int16);
}
...
static void SBC16(long Addr)
{
	...
	if (CheckDecimal()) {
		...
		if ((ICPU.Registers.A.W ^ Work16) & (ICPU.Registers.A.W ^ (uint16)Int32) & 0x8000)
			SetOverflow();
		else
			ClearOverflow();
...
static void SBC8(long Addr)
{
	...
	if (CheckDecimal()) {
		...
		ICPU._Carry = Int16 >= 0;
		if ((ICPU.Registers.AL ^ Work8) & (ICPU.Registers.AL ^ (uint8)Int16) & 0x80)
			SetOverflow();
		else
			ClearOverflow();
...
static void STA16(long Addr) { S9xSetWord(ICPU.Registers.A.W, Addr); }

static void STA8(long Addr) { S9xSetByte(ICPU.Registers.AL, Addr); }

static void STX16(long Addr) { S9xSetWord(ICPU.Registers.X.W, Addr); }

static void STX8(long Addr) { S9xSetByte(ICPU.Registers.XL, Addr); }

static void STY16(long Addr) { S9xSetWord(ICPU.Registers.Y.W, Addr); }

static void STY8(long Addr) { S9xSetByte(ICPU.Registers.YL, Addr); }

static void STZ16(long Addr) { S9xSetWord(0, Addr); }
