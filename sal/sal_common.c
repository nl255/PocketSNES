    0x1830607e, 0x7e060c,   0x18181878, 0x781818,   0x180c0602, 0x406030,   0x1818181e, 0x1e1818,   0x63361c08,
    0x0,	0x0,	    0x7f0000,	0xc060300,  0x0,	0x603c0000, 0x7c667c,	0x663e0606, 0x3e6666,
    0x63c0000,	0x3c0606,   0x667c6060, 0x7c6666,   0x663c0000, 0x3c067e,   0xc3e0c38,	0xc0c0c,    0x667c0000,
    0x3e607c66, 0x663e0606, 0x666666,	0x181c0018, 0x3c1818,	0x18180018, 0xe181818,	0x36660606, 0x66361e,
    0x1818181c, 0x3c1818,   0x7f370000, 0x63636b,   0x663e0000, 0x666666,   0x663c0000, 0x3c6666,   0x663e0000,
    0x63e6666,	0x667c0000, 0x607c6666, 0x663e0000, 0x60606,	0x67c0000,  0x3e603c,	0x187e1800, 0x701818,
    0x66660000, 0x7c6666,   0x66660000, 0x183c66,   0x63630000, 0x363e6b,   0x3c660000, 0x663c18,   0x66660000,
    0x3e607c66, 0x307e0000, 0x7e0c18,	0xc181870,  0x701818,	0x18181818, 0x18181818, 0x3018180e, 0xe1818,
    0x794f0600, 0x30};
...
s8 *sal_LastErrorGet() { return &mLastError[0]; }

void sal_LastErrorSet(char *msg) { strcpy(mLastError, msg); }
...
{
	if (mBpp == 8)
		sal_VideoDrawRect8(x, y, width, height, (u8)color, (uint32_t *)sal_VideoGetBuffer());
	else
		sal_VideoDrawRect16(x, y, width, height, (u16)color, (uint32_t *)sal_VideoGetBuffer());
}
...
{
	if (mBpp == 8)
		sal_VideoPrint8(x, y, buffer, (u8)color, (uint32_t *)sal_VideoGetBuffer());
	else
		sal_VideoPrint16(x, y, buffer, (u16)color, (uint32_t *)sal_VideoGetBuffer());
}
...
static void sal_VideoClear8(u8 color)
{
	s32 x, y, w, h, pitch;
...
u32 sal_InputHeld() { return mInputHeld; }

u32 sal_InputRepeat() { return mInputRepeat; }
...
void sal_InputIgnore() { mInputIgnore = 1; }

u32 sal_VideoGetBpp() { return mBpp; }
...
s32 sal_ZipSave(const char *filename, s8 *firstFilename, s8 *buffer, s32 size)
{
	...
	ret = zipOpenNewFileInZip(fd, firstFilename, NULL, NULL, 0, NULL, 0, NULL, Z_DEFLATED, Z_BEST_COMPRESSION);
...
const char *sal_DirectoryGetUser(void) { return getenv("HOME"); }
...
s32 sal_HighlightBar(s32 width, s32 height, s32 x, s32 y)
{
	...
	for (y2 = 0; y2 < height; y2++) {
		for (x2 = 0; x2 < width; x2++) {
			...
			// final colour blend, dont need to do the inverse of g/b because we're only blending red with
			// the background!
...
s32 sal_ImageLoad(const char *fname, void *dest, u32 width, u32 height)
{
	...
	png_read_png(png_ptr, info_ptr, PNG_TRANSFORM_STRIP_16 | PNG_TRANSFORM_STRIP_ALPHA | PNG_TRANSFORM_PACKING,
		     NULL);
