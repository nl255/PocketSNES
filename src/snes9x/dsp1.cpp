		...
		//		}
			...
			if (DSP1.in_count) {
				...
				if (--DSP1.in_count == 0) {
					...
					case 0x00: // Multiple
						Op00Multiplicand =
						    (int16)(DSP1.parameters[0] | (DSP1.parameters[1] << 8));
						Op00Multiplier =
						    (int16)(DSP1.parameters[2] | (DSP1.parameters[3] << 8));
					...
					case 0x02: // Parameter (Projection)
						...
						Op02AAS =
						    (unsigned short)(DSP1.parameters[10] | (DSP1.parameters[11] << 8));
						Op02AZS =
						    (unsigned short)(DSP1.parameters[12] | (DSP1.parameters[13] << 8));
